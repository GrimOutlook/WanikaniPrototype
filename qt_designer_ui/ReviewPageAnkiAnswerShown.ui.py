...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1177, 24))
        ...
        self.correctResponse.clicked.connect(self.centralwidget.hide)
        self.wrongResponse.clicked.connect(self.centralwidget.hide)
